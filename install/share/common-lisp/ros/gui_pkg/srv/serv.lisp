...
(cl:defmethod cl:initialize-instance :after ((m <serv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'serv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gui_pkg-srv:<serv-request> is deprecated: use gui_pkg-srv:serv-request instead.")))

(cl:ensure-generic-function 'code-val :lambda-list '(m))
(cl:defmethod code-val ((m <serv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gui_pkg-srv:code-val is deprecated.  Use gui_pkg-srv:code instead.")
  (code m))
...
(cl:defmethod cl:initialize-instance :after ((m <serv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'serv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gui_pkg-srv:<serv-response> is deprecated: use gui_pkg-srv:serv-response instead.")))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <serv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gui_pkg-srv:error-val is deprecated.  Use gui_pkg-srv:error instead.")
  (error m))
